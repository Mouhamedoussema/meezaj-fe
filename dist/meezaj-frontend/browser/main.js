...
var routes = [
  {
    path: "",
    loadComponent: () => import("./chunk-34ETL72X.js").then((m) => m.HomeComponent)
  },
  {
    path: "shop",
    loadComponent: () => import("./chunk-RZOWG7YO.js").then((m) => m.ShopComponent)
  },
  {
    path: "product/:id",
    loadComponent: () => import("./chunk-224TXWFH.js").then((m) => m.ProductComponent)
  },
  {
    path: "cart",
    loadComponent: () => import("./chunk-MG3I4EBO.js").then((m) => m.CartComponent)
  },
  {
    path: "checkout",
    loadComponent: () => import("./chunk-5QZ26KCC.js").then((m) => m.CheckoutComponent)
  },
  {
    path: "admin/login",
    loadComponent: () => import("./chunk-E4KL54KQ.js").then((m) => m.AdminLoginComponent)
  },
  {
    path: "admin",
    loadComponent: () => import("./chunk-H52S22U5.js").then((m) => m.AdminLayoutComponent),
    canActivate: [authGuard],
    children: [
      {
        path: "dashboard",
        loadComponent: () => import("./chunk-CXVKNU2E.js").then((m) => m.AdminDashboardComponent)
      },
      {
        path: "products",
        loadComponent: () => import("./chunk-D6WO5M64.js").then((m) => m.AdminProductsComponent)
      },
      {
        path: "orders",
        loadComponent: () => import("./chunk-6II6I33I.js").then((m) => m.AdminOrdersComponent)
      },
...
var NavbarComponent = class _NavbarComponent {
  ...
  static {
    this.\u0275fac = function NavbarComponent_Factory(t) {
      return new (t || _NavbarComponent)(\u0275\u0275directiveInject(CartService));
    };
  }
  static {
    ...
    }, standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 17, vars: 5, consts: [[1, "nav-inner", "container"], [1, "nav-left"], ["routerLink", "/", 1, "nav-logo"], [1, "nav-center"], ["routerLink", "/", "routerLinkActive", "active", 1, "nav-link", 3, "routerLinkActiveOptions"], ["routerLink", "/shop", "routerLinkActive", "active", 1, "nav-link"], [1, "nav-right"], ["routerLink", "/cart", 1, "cart-btn"], ["width", "20", "height", "20", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "1.5"], ["d", "M6 2L3 6v14a2 2 0 002 2h14a2 2 0 002-2V6l-3-4z"], ["x1", "3", "y1", "6", "x2", "21", "y2", "6"], ["d", "M16 10a4 4 0 01-8 0"], [1, "cart-badge"]], template: function NavbarComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "nav")(1, "div", 0)(2, "div", 1)(3, "a", 2);
        \u0275\u0275text(4, "MEEZAJ");
        \u0275\u0275elementEnd()();
        ...
        \u0275\u0275element(13, "path", 9)(14, "line", 10)(15, "path", 11);
        \u0275\u0275elementEnd();
        \u0275\u0275template(16, NavbarComponent_Conditional_16_Template, 2, 1, "span", 12);
        \u0275\u0275elementEnd()()()();
      }
      if (rf & 2) {
...
var FooterComponent = class _FooterComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _FooterComponent, selectors: [["app-footer"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 38, vars: 1, consts: [[1, "container"], [1, "footer-grid"], [1, "footer-brand"], [1, "brand-name"], [1, "brand-tagline"], [1, "footer-links"], [1, "footer-heading"], ["routerLink", "/"], ["routerLink", "/shop"], ["routerLink", "/cart"], ["href", "#"], ["href", "mailto:hello@meezaj.tn"], [1, "footer-bottom"], ["routerLink", "/admin/login", 1, "admin-link"]], template: function FooterComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "footer")(1, "div", 0)(2, "div", 1)(3, "div", 2)(4, "span", 3);
        \u0275\u0275text(5, "MEEZAJ");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(6, "p", 4);
        \u0275\u0275text(7, "Wear Your Identity");
        \u0275\u0275elementEnd()();
        ...
        \u0275\u0275text(23, "Shipping & Returns");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(24, "a", 10);
        \u0275\u0275text(25, "Size Guide");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(26, "div", 5)(27, "span", 6);
        \u0275\u0275text(28, "Contact");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(29, "a", 11);
        \u0275\u0275text(30, "hello@meezaj.tn");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(31, "a", 10);
        \u0275\u0275text(32, "Instagram");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(33, "div", 12)(34, "span");
        \u0275\u0275text(35);
        \u0275\u0275elementEnd();
      ...
      if (rf & 2) {
        \u0275\u0275advance(35);
        \u0275\u0275textInterpolate1("\xA9 ", ctx.year, " MEEZAJ. All rights reserved.");
      }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(FooterComponent, { className: "FooterComponent", filePath: "src\\app\\components\\footer\\footer.component.ts", lineNumber: 43 });
})();
